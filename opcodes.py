...
OPCODES = {
    ...
    "ecdsa_pk_decompress": [650, 1, 1, 1, executor.ecdsa_pk_decompress_handle],
    "ecdsa_pk_recover": [2000, 1, 1, 1, executor.ecdsa_pk_recover_handle],
    "mulw": [1, 1, 1, 0, executor.mulw_handle],
    "addw": [1, 1, 1, 0, executor.addw_handle],
    "divmodw": [20, 1, 1, 0, executor.divmodw_handle],
    "extract_uint16": [1, 1, 1, 0, executor.extract_uint16_handle],
    "extract_uint32": [1, 1, 1, 0, executor.extract_uint32_handle],
    "extract_uint64": [1, 1, 1, 0, executor.extract_uint64_handle],
    "setbyte": [1, 1, 1, 0, executor.setbyte_handle],
    "expw": [10, 1, 1, 0, executor.expw_handle],
    "getbit": [1, 1, 1, 0, executor.getbit_handle],
    "setbit": [1, 1, 1, 0, executor.setbit_handle],
    "bitlen": [1, 1, 1, 0, executor.bitlen_handle],
    "select": [1, 1, 1, 0, executor.select_handle],
    "b+": [10, 1, 1, 0, executor.Badd_handle],
    "b-": [10, 1, 1, 0, executor.Bsub_handle],
    "b/": [20, 1, 1, 0, executor.Bdiv_handle],
    "b*": [20, 1, 1, 0, executor.Bmul_handle],
    "b<": [1, 1, 1, 0, executor.BLT_handle],
    "b>": [1, 1, 1, 0, executor.BGT_handle],
    "b<=": [1, 1, 1, 0, executor.BLE_handle],
    "b>=": [1, 1, 1, 0, executor.BGE_handle],
    "b==": [1, 1, 1, 0, executor.BEQ_handle],
    "b!=": [1, 1, 1, 0, executor.BNEQ_handle],
    "b%": [20, 1, 1, 0, executor.Brem_handle],
    "b|": [6, 1, 1, 0, executor.Bbit_or_handle],
    "b&": [6, 1, 1, 0, executor.Bbit_and_handle],
    "b^": [6, 1, 1, 0, executor.Bbit_xor_handle],
    "b~": [4, 1, 1, 0, executor.Bbit_not_handle],
    "itxn": [1, 1, 0, 1, executor.itxn_handle],
    "itxna": [1, 1, 0, 2, executor.itxna_handle],
}
